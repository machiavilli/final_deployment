...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    public function getRoles(): array
    {
        ...
        // Customers need ROLE_USER; staff/admin get it via role_hierarchy from ROLE_STAFF / ROLE_ADMIN
        if (
    ...
    /**
     * @return list<string> Roles stored in the database (without hierarchy additions).
     */
